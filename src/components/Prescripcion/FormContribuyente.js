...
class FormContribuyente extends Component {
    ...
    constructor(props, context) {
        ...
        this.handleSearchByCiLocalOnClick = this.handleSearchByCiLocalOnClick.bind(this);
  ...
  //console.log(tipo_doc_res);
            if (res !== undefined && res.status === true) {
                if (res.status === true && res.TipoDocumento !== null) {  //is ok
                    ...
                    //esto para el representante legal 
        ...
        const tipo_soc_res = this.fetch.fetchGet(`api/TipoSociedad/getAll`);
        tipo_soc_res.then(res => {
          console.log(tipo_soc_res);
            if(res !== undefined && res.status === true){
                if (res.status === true && res.TipoSociedad !== null) {  //is ok
                    console.log(res.TipoSociedad);
                    const listItems = res.TipoSociedad.map((item, index) => {
                        return <option key={index} value={item.id} code={item.code}>{item.code}</option>
                    });
                    this.setState({ optionsTipoSociedad: listItems, optionsTipoSociedadContribuyente: listItems });
            }
           }
        })
    ...
    /* MANDA AKA EL EXPEDIDO DE CARNET*/
    componentDidUpdate(prevProps, prevState, snapshot) {
        ...
        var $_dropdown_menu_per_sol_repre = window.jQuery("#dropdown-contribuyente-tipo-doc_representante");
        if ($_dropdown_menu_per_sol_repre.length > 0 && $_dropdown_menu_per_sol_repre.find("a").length > 0) {
            window.event_drop_down($_dropdown_menu_per_sol_repre, function (code_ci_exp) {
                if (self.state.ciExpedidoRepre === 'EX')
                    document.getElementsByName("representante_persona[expedido_en]")[0].value = code_ci_exp
            });
        }
    ...
    handleCheckTipoDocumentoOnchange(event) {
        ...
        if (event.target.checked) {
            //mostrar
            document.getElementsByName('representante_persona[id_tipo_documento]')[0].removeAttribute('disabled')
            document.getElementsByName('representante_persona[id_tipo_documento]')[0].setAttribute('data-parsley-required', true)
            document.getElementsByName("representante_persona[id_tipo_documento]")[0].selectedIndex = 0
        } else {
            //ocultar
            document.getElementsByName('representante_persona[id_tipo_documento]')[0].setAttribute('disabled', true)
            document.getElementsByName('representante_persona[id_tipo_documento]')[0].setAttribute('data-parsley-required', false)
            document.getElementsByName("representante_persona[id_tipo_documento]")[0].selectedIndex = 0
        }
    }
    ...
    handleOnchangeTipoDocumento(event) {
        ...
        if (target.selectedOptions[0].getAttribute('code') === 'CI') {
            document.getElementsByName("tipo_documento")[0].value = 'CI';
        ...
        if (target.selectedOptions[0].getAttribute('code') === 'NIT') {
            document.getElementsByName("tipo_documento")[0].value = 'NIT';
...
/**
 * @param {es para el representnate legal natural } event 
 */
    handleSearchByCiLocalOnClick(event){
        event.preventDefault();
        var ci = "";
        let input_search = "";
        var self = this;
        ...
        const response = this.fetch.fetchGet(`api/PrescripcionRepresentante/getPersonaRepreByCi/${ci}`);
        console.log(response);
        response.then(res => {
            if (res !== undefined && res.status === true) {
                //let persona_natural = res.persona_natural

                document.getElementsByName("representante_persona[nombre]")[0].value = res.persona_representante.nombre;
                document.getElementsByName("representante_persona[apellido_paterno]")[0].value = res.persona_representante.apellido_paterno;
                document.getElementsByName("representante_persona[apellido_materno]")[0].value = res.persona_representante.apellido_materno;

                self.setState({ ciExpedido: res.persona_representante.lugar_ci });
    ...
    handleSearchByNitLocalOnClick(event){
        event.preventDefault();
        var nit = "";
        var self = this;
        if (event.target.tagName === 'I') {
        ...
        //          console.log(res);
                    if (res.status == true){
                        ...
                        document.getElementsByName("representante_persona[razon_social]")[0].value = persona_juridica.razon_social;
                    ...
                    {this.props.contribuyente === 'NATURAL' ?
                        <div className="row">
                            <div className="form-group col-12 col-md-4" >
                                <label htmlFor="persona[numero_documento]">Cedula Identidad CI:</label>{/*un cambio*/}
                            ...
                            <div className="form-group col-12 col-md-4" >
                                <label htmlFor="domicilio[correo]">Correo:</label>
                                <input type="text" className="form-control" placeholder="Correo/Email" name='domicilio[correo]' value="pedrofernandez@gmail.com" disabled />
                            </div>
                        </div>
                      : ""}
                    ...
                    {this.props.contribuyente === 'NATURAL' ?
                        <div className="row">
                            ...
                            <div className="form-group col-12 col-md-4">
                                ...
                                <input type="text" className="form-control" placeholder="Apellido Paterno" name="persona[apellido_paterno]"/>
                            </div>
                            <div className="form-group col-12 col-md-4">
                                <label htmlFor="persona[apellido_materno]">Apellido Materno:</label>
                                <input type="text" className="form-control" placeholder="Apellido Materno" name="persona[apellido_materno]"/>
                            </div>
                        </div>
                       : ""}
                                ...
                                <div className="input-group ">
                                    ...
                                    <div className="input-group-append">
                                       {/* <button type="button" className="btn btn-outline-secondary">SN</button>
                                        ...
                                        <button className="btn btn-outline-secondary btn-dark" type="button" data-toggle="tooltip" data-placement="top"
                                            title="Buscar por NIT"><i className="fa fa-search" aria-hidden="true" onClick={this.handleSearchByNitOnClick}></i></button>
                                    </div>
                                </div>
                            </div>

                            <div className="form-group col-12 col-md-4" >
                                <label htmlFor="pres_persona_juridica[razon_social]">Razon Social:</label>
                                <input type="text" className="form-control" placeholder="Razon Social" name='pres_persona_juridica[razon_social]' />
                            </div>    
                            <div className="form-group col-12 col-md-4" >
                            <label htmlFor="uname">Tipo Sociedad</label>
                                    <select className="form-control " name={'pres_persona_juridica[id_tipo_sociedad]'} >
                                    <option defaultValue value="">Seleccione Tipo Sociedad</option>
                                    {this.state.optionsTipoSociedad}
                                </select>
                                <input type="hidden" name='tipo_documento'></input>
                            </div>

                            <div className="form-group col-12 col-md-4" >
                                <label htmlFor="persona[email]">Correo:</label>
                                <input type="text" className="form-control" placeholder="Correo/Email" name='persona[email]' value="pedrofernandez@gmail.com" disabled />
                            </div>
                        </div>
                        : ""}
                    ...
                    <div className="row">
                        <div className="col-12 col-md-4 form-group">
                            ...
                            <div className="input-group mb-3">
                                ...
                                <select className="form-control" name={'representante_persona[id_tipo_documento]'} onChange={this.handleOnchangeTipoDocumento} disabled >
                        ...
                        <div className='row'>
                            <div className="col-12 col-md-4 form-group">
                                {/*<label htmlFor="pres_representante_legal[num_docum_repre]">CI:</label>
                                <input type="text" className="form-control" placeholder="Ci" name="representante_persona[numero_documento]"/>*/}
                                <label htmlFor="representante_persona[numero_documento]">Documento de Identidad:</label>{/*un cambio*/}
                                <div className="input-group ">
                                    <input type="text" className="form-control" aria-label="Text input with segmented dropdown" name="representante_persona[numero_documento]" placeholder="Número Documento" />
                                    <div className="input-group-append">
                                        <button type="button" className="btn btn-outline-secondary">SN</button>
                                        <input type="hidden" name="representante_persona[expedido_en]" />
                                        <button 
                                            type="button" 
                                        ...
                                        <div className="dropdown-menu " id="dropdown-contribuyente-tipo-doc_representante" >
                                            {this.state.optionsCiExpedido}
                                        </div>
                                        <button 
                                            ...
                                            data-placement="top"
                                            title="Buscar por CI"
                                            onClick={this.handleSearchByCiLocalOnClick}>
                            ...
                            <div className="col-12 col-md-4 form-group">
                                <label htmlFor="pres_representante_legal[razon_social]">Nombres:</label>
                                <input type="text" className="form-control" placeholder="Nombres" name="representante_persona[nombre]" required />
                            </div>
                            <div className="col-12 col-md-4 form-group">
                                <label htmlFor="pres_representante_legal[razon_social]">Apellido Paterno:</label>
                                <input type="text" className="form-control" placeholder="Nombres" name="representante_persona[apellido_paterno]" required />
                            </div>
                            <div className="col-12 col-md-4 form-group">
                                <label htmlFor="pres_representante_legal[razon_social]">Apellido Materno:</label>
                                <input type="text" className="form-control" placeholder="Nombres" name="representante_persona[apellido_materno]" required />
                            </div>                            
                        </div>
                         :""}
                       
                        {/*this.state.showFormRepresentanteLegalNatural || */}
                        {this.state.showFormRepresentanteLegalJuridico ?
                        <div className="row">
                            <div className="col-12 col-md-4 form-group">
                                {/*<label htmlFor="pres_representante_legal[num_docum_repre]">Nit:</label>
                                <input type="text" className="form-control" placeholder="Nit" name="representante_persona[nit]"/>*/}
                                <label htmlFor="representante_persona[nit]">Nit:</label>{/*un cambio*/}
                                <div className="input-group ">
                                    <input type="text" className="form-control" aria-label="Text input with segmented dropdown" name="representante_persona[nit]" placeholder="Número Documento" />
                                    <div className="input-group-append">
                                        <button className="btn btn-outline-secondary btn-dark" type="button" data-toggle="tooltip" data-placement="top"
                                            title="Buscar por CI"><i className="fa fa-search" aria-hidden="true" onClick={this.handleSearchByNitLocalOnClick}></i></button>
                                    </div>
                                </div>
                            </div>
                            <div className="col-12 col-md-4 form-group">
                                 <label htmlFor="representante_persona[razon_social]">Razon Social:</label>
                                 <input type="text" className="form-control" placeholder="Nombres" name="representante_persona[razon_social]" required />
                            </div>
                            <div className="col-12 col-md-4 form-group" >
                            <label htmlFor="uname">Tipos Sociedades</label>
                                    <select className="form-control" name={'representante_persona[id_tipo_sociedad]'} >
                                    <option defaultValue value="">Seleccione Tipo Sociedad</option>
                                    {this.state.optionsTipoSociedad}
                                </select>
                                <input type="hidden" name='tipo_sociedad'></input>
                            </div>
                        </div>
                        : ""}
                      <div className="row">
                        {this.state.showFormRepresentanteLegalNatural || this.state.showFormRepresentanteLegalJuridico ?
                            <div className="col-12 col-md-4 form-group">
                                ...
                                <input type="text" className="form-control" placeholder="Teléfono" name="domicilio[telefono]" required />
                            </div>
                            : ""
                        }
                        {this.state.showFormRepresentanteLegalNatural || this.state.showFormRepresentanteLegalJuridico ?
                            <div className="col-12 col-md-4 form-group">
                                ...
                                <input type="correo" className="form-control" placeholder="Correo/Email" name="domicilio[correo]" required data-parsley-required="true" />
                            </div>
                            : ""
                        }
                    </div>
